...
const transformers = useRegisteredTransformers();
...
const registeredElements = useRegisteredElements();
const registeredValueProcessors = useRegisteredValueProcessors();
...
const validators = useRegisteredValidators();
